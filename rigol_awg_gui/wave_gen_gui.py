...
script_wave_demo = """# Example to generate custom wave:
...
""".format(
    wave_gen.User.TOTAL_TIME_NAME, wave_gen.User.IMPL_FUNC_NAME
)
...
class ScriptWaveWidget(WaveWidgetBase):
    ...
    def gen_wave(self):
        ...
        return WaveInfo(
            type="script", params_val=None, params_text=text, data={"x": x, "y": y}
        )
