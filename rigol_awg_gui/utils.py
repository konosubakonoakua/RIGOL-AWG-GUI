...
def openDirDialog(prefer_dir="./"):
    ...
    path = QFileDialog.getExistingDirectory(
        None, "Open Directory", prefer_dir, QFileDialog.ShowDirsOnly
    )
    if len(path) == 0:
        path = None
...
def openFileDialog(filter=None, prefer_dir="./"):
    ...
    path = QFileDialog.getOpenFileName(None, "Open File", prefer_dir, filter=filter)[0]
...
def saveFileDialog(filter=None, prefer_dir="./"):
    ...
    path = QFileDialog.getSaveFileName(None, "Save File", prefer_dir, filter=filter)[0]
